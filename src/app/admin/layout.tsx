    ...
    <div className="min-h-screen bg-[#f7f6f2]">
      <div className="mx-auto w-full max-w-6xl px-6 py-10">
        <div className="grid items-start gap-8 lg:grid-cols-[260px_1fr]">
          <aside className="sticky top-8 max-h-[calc(100vh-4rem)] overflow-y-auto rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_12px_30px_rgba(15,23,42,0.06)]">
          ...
          <div className="self-start space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-4 rounded-3xl border border-slate-200 bg-white px-6 py-5 shadow-[0_12px_30px_rgba(15,23,42,0.06)]">
              <div>
                <p className="text-xs font-medium text-slate-400">Espace admin</p>
